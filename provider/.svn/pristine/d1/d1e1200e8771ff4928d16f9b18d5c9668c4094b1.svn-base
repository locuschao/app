<?php
class Service_SaleReportQueue extends Common_Service
{
    /**
     * @var null
     */
    ...
    /**
     * @return Table_SaleReportQueue|null
     */
    public static function getModelInstance()
    {
        if (is_null(self::$_modelClass)) {
            self::$_modelClass = new Table_SaleReportQueue();
        }
    ...
    public function pickTask($taskNumber){
        ...
        $condition = array('srq_status' => 0, 'execute_times' => 0);
        // 此处排序顺序很重要，不能改
