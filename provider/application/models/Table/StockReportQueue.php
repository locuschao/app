<?php
class Table_StockReportQueue
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_StockReportQueue();
    }
    ...
    {
        return new Table_StockReportQueue();
    }
     ...
     * @return mixed
     */
    public function deleteIn($value, $field = "srq_id")
    {
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["frq_status"]) && $condition["frq_status"] != ""){
    ...
    public function generateTasks() {
        ...
        $sql = "INSERT INTO {$this->_table->info('name')} (user_id,ute_id, erp_no, erp_url, token, execute_times, srq_status, srq_create_time, srq_update_time) 
            ...
            FROM user_to_erp WHERE ute_status = 1 AND ute_erp_url <> '' AND ute_token <> ''";
