<?php
class Service_ProductParse extends Common_Service
{
    /**
     * @var null
     */
    ...
    /**
     * @return Table_ProductParse|null
     */
    public static function getModelInstance()
    {
        if (is_null(self::$_modelClass)) {
            self::$_modelClass = new Table_ProductParse();
        }
     ...
     * @return mixed
     */
    public static function deleteIn($value, $field = "pp_id")
    {
        $model = self::getModelInstance();
