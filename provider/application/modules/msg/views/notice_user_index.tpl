...
<div id="module-container">
    <div id="ez-wms-edit-dialog" style="display:none;">
        ...
        <tr>
            <td class="dialog-module-title">用户id:</td>
            <td><input type="text" name="E2" id="E2" validator="required" err-msg="<{t}>require<{/t}>" class="input_text"/><span class="msg">*</span></td>
        </tr>
            </tbody>
        </table>
    </div>
    ...
    <div id="search-module">
       ...
       用户id：<input type="text" name="E2" id="E2" class="input_text keyToSearch"/>
