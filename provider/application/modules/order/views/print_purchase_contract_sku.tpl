    ...
    <table width="100%" border="1" cellpadding="0" cellspacing="0" style="margin:0 auto;border-collapse:collapse;">
        ...
        <tr>
            <td colspan="8">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:0 auto;">
                  <tr>
                    <!-- <td width="20%" valign="top" style="text-align:left;"><img src="<{$host}>/barcode/ec/img.php?text=<{$purchaseInfo.po_code}>&scale=1&thickness=30" /></td> -->
        ...
        <tr>
             <td colspan="8" align=left>
	            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:0 auto;">
	              <tr>
	                <td colspan="2" style="text-align:left;text-indent:3px;">采购仓库：<{$purchaseInfo.warehouse_desc}></td>
           ...
           <td colspan="8">
               <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:0 auto;">
                   <tr>
                    <td width="70">
		               <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:0 auto;">
		                   <tr><td style="text-align:left;text-indent:2px;">采购方：</td></tr>
		                   <tr><td style="height:30px;text-align:left;text-indent:2px;">地址：</td></tr>
		                   <tr><td style="text-align:left;text-indent:2px;">联系人：</td></tr>
		                   <tr><td style="text-align:left;text-indent:2px;">电话：</td></tr>
		                   <tr><td style="text-align:left;text-indent:2px;">传真：</td></tr>
		               </table> 
		            </td>
		            <td width="270">
		                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:0 auto;">
		                    <tr><td style="text-align:left;text-indent:2px;"><{if $company.company_name_cn}><{$company.company_name_cn}><{else}>&nbsp;<{/if}></td></tr>
		                    <tr><td style="height:30px;text-align:left;text-indent:2px;"><{if $company.company_address_cn}><{$company.company_address_cn}><{else}>&nbsp;<{/if}></td></tr>
		                    <tr><td style="text-align:left;text-indent:2px;"><{if $company.company_contact_name}><{$company.company_contact_name}><{else}>&nbsp;<{/if}></td></tr>
		                    <tr><td style="text-align:left;text-indent:2px;"><{if $company.company_contact_tel}><{$company.company_contact_tel}><{else}>&nbsp;<{/if}></td></tr>
		                    <tr><td style="text-align:left;text-indent:2px;"><{if $company.company_contact_fax}><{$company.company_contact_fax}><{else}>&nbsp;<{/if}></td></tr>
		                </table>
		            </td>
		            <td width="70">
		               <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:0 auto;">
		                   <tr><td style="text-align:left;text-indent:2px;">供货方：</td></tr>
		                   <tr><td style="height:30px;text-align:left;text-indent:2px;">地址：</td></tr>
		                   <tr><td style="text-align:left;text-indent:2px;">联系人：</td></tr>
		                   <tr><td style="text-align:left;text-indent:2px;">电话：</td></tr>
		                   <tr><td style="text-align:left;text-indent:2px;">传真：</td></tr>
		            ...
		            <td width="270">
		                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:0 auto;">
		                    <tr><td style="text-align:left;text-indent:2px;"><{$purchaseInfo.supplier_name}></td></tr>
		                    <tr><td style="height:30px;text-align:left;text-indent:2px;"><{$purchaseInfo.contact_address}></td></tr>
		                    <tr><td style="text-align:left;text-indent:2px;"><{$purchaseInfo.contact_name}></td></tr>
		                    <tr><td style="text-align:left;text-indent:2px;"><{$purchaseInfo.contact_tel}></td></tr>
		                    <tr><td style="text-align:left;text-indent:2px;"><{$purchaseInfo.contact_fax}></td></tr>
		                </table>
		            </td>
                   </tr>
               </table>
        ...
        <!-- 交货日期 -->
        <tr><td colspan="8" style="text-align:right;">交货日期：<{$purchaseInfo.date_eta}>&nbsp;&nbsp;</td></tr>
        <tr>
        ...
        <!-- SKU种类、合计金额（小写） -->
        <tr>
            <td colspan="4" style="text-align:left;text-indent:2px;">SKU种类：<{count($detailProduct)}>  SKU总数：<{$purchaseInfo.count_sum}>  付款方式：<{$purchaseInfo.pay_type}>  结算方式：<{$purchaseInfo.account_type}></td>
            <td colspan="4" style="text-align:left;text-indent:2px;">合计金额（小写）：<{sprintf("%0.3f", $purchaseInfo.payable_amount + $purchaseInfo.pay_ship_amount)}> <{$purchaseInfo.currency_code}></td>
        </tr>
        <!-- 运费、合计金额（大写） -->
        <tr>
